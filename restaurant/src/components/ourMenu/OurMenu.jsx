                                        ...
                                        {quantity > 0 ? (
                                            <>
                                                <button className="w-8 h-8 rounded-full bg-amber-900/40 flex items-center justify-center hover:bg-amber-800/50 
                                                    transition-colors" onClick={() => quantity > 1 ? updateQuantity(cartEntry._id, quantity - 1) : removeFromCart(cartEntry._id)}
                                                >
                                                ...
                                                <button className="w-8 h-8 rounded-full bg-amber-900/40 flex items-center justify-center hover:bg-amber-800/50 
                                                    transition-colors" onClick={() => updateQuantity(cartEntry._id, quantity + 1)}
                                                >
                                                    <FaPlus className="text-amber-100" />
                                                </button>
                                            </>
                                        ) : (
                                            <button onClick={() => handleAddToCart(item)} className='bg-amber-900/40 px-4 py-1.5 rounded-full font-cinzel text-sm uppercase sm:text-sm tracking-wider duration-300 transition-transform 
