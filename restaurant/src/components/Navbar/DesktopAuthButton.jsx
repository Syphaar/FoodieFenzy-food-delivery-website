...
// export const DesktopAuthButton = ({ isAuthenticated, handleLogout }) => {
...
// export const MobileAuthButton = ({ isAuthenticated, handleLogout, setIsOpen }) => {
//   const navigate = useNavigate();
//   return isAuthenticated ? (
...
//     </button>
//   ) : (
//     <button onClick={() => { navigate('/login'); setIsOpen(false) }} className="px-3 lg:px-6 py-1.5 md:py-2 lg:py-3 bg-linear-to-br from-amber-600 to-amber-700 
