...
//         <NavLink
//           to="/"
//           className="text-xl md:text-2xl lg:text-4xl bg-linear-to-r from-amber-400 
//           to-amber-600 bg-clip-text text-transparent tracking-wider drop-shadow-[0_2px_2px] 
//           drop-shadow-black -translate-x-2 truncate md:truncate-none"
//         >
//           Foodie-Frenzy
//           <div
//             className="h-1 bg-linear-to-r from-amber-600/30 via-amber-400/50 to-amber-600/30 
//             mt-2 shadow-[0_2px_5px] shadow-amber-500/20"
//           ></div>
//         </NavLink>
//       </div>
