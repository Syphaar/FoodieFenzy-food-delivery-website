...
const MyOrder = () => {
    ...
    // IN CASE OF ERROR
    if(error) return (
        <div className="min-h-screen bg-linear-to-br from-[#1a120b] via-[#2a1e14] to-[#3e2b1d] flex items-center 
            justify-center text-red-400 text-xl gap-4"
        >
            <p>{error}</p>
    ...
    if (loading) {
        return (
            <div className="min-h-screen bg-linear-to-br from-[#1a120b] via-[#2a1e14] to-[#3e2b1d] flex items-center justify-center">
    ...
    <div className='min-h-screen bg-linear-to-br from-[#1a120b] via-[#2a1e14] to-[#3e2b1d] py-12 px-4 sm:px-6 lg:px-8'>
      <div className="mx-auto max-w-7xl">
        ...
        <div className="bg-[#4b3b3b]/80 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border-2 border-amber-500/20">
            <h2 className="text-3xl font-bold mb-8 bg-linear-to-r from-amber-300 to-amber-500 bg-clip-text 
                                    ...
                                    <tr key={order._id} className='border-b border-amber-500/20 hover:bg-[#3a2b2b]/30 transition-colors group'>
                                        ...
                                        <td className="p-4">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className={`px-4 py-2 rounded-lg ${status.bg} ${status.color} border border-amber-500/20 text-sm`}>{status.label}</span>
                                            </div>
                                        </td>
                                    </tr>
                                )
