  ...
  useEffect(() => {
    ...
    if(paymentStatus) {
      ...
      if (paymentStatus === 'success' && sessionId) {
        ...
        setError('Payment was cancelled or failed. Please contct support')
        setLoading(false)
      }
    }
        ...
        <form className="grid lg:grid-cols-2 gap-12" onSubmit={handleSubmit}>
          ...
          <div className="bg-[#4b3b3b]/80 p-6 rounded-3xl space-y-6">
            ...
            <div className="space-y-4 mb-6">
              <h3 className="text-lg font-semibold text-amber-100 capitalize">Your order items</h3>
            ...
            <button type='submit' disabled={loading} className="w-full bg-linear-to-r from-red-600 to-amber-600 py-4 
...
const Input = ({label, name, type = 'text', value, onChange}) => (
  <div>
    ...
    <input type={type} name={name} value={value} onChange={onChange} required className='w-full bg-[#3a2b2b]/50 
