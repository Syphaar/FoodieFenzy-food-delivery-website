...
import FloatingParticle from "../floatingParticles/FloatingParticles"
import "./AboutHome.css"

const AboutHome = () => {
  return (
    <div className='min-h-screen bg-linear-to-br from-[#0f0a0a] via-[#1a1212] to-[#2a1e1e] text-white py-10 
        sm:py-20 relative overflow-hidden'
    >
        ...
        >
          <div className="w-full order-1 lg:order-2 space-y-8 sm:space-y-12 relative">
            <div className="space-y-4 sm:space-y-8 px-4 sm:px-0">
              <h2 className="text-3xl sm:text-4xl md:text-5xl xl:text-6xl font-bold leading-tight">
                  <span className='font-cursive text-4xl sm:text-5xl md:text-6xl bg-linear-to-r from-amber-400 
                  ...
                  <span className="inline-block mt-2 sm:mt-4 text-2xl sm:text-3xl md:text-4xl opacity-90 font-light">
                    Where Flavour Dance &amp; Memories Bloom
                  </span>
              </h2>
              <p className="text-base sm:text-lg md:text-xl opacity-90 leading-relaxed max-w-3xl font-serif 
                italic border-1-4 bg-amber-500/60 pl-4 sm:pl-6 py-2 bg-linear-to-r from-white/5 to-transparent"
              >
                "In our kitchen, passion meets perecision. We craft not just meals, but culinary journeys that linger 
                on the palate and in our hearts."
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8 px-4 sm:px-0">
              {aboutfeature.map((item, index) => {
                return (
                  <div key={index} className="flex flex-col items-center justify-center gap-3 sm:gap-4
                    transition-transform duration-300 p-4 sm:p-5 hover:translate-x-2"
                  >
                    <div className={`p-3 sm:p-4 rounded-full bg-linear-to-br ${item.color} transition-transform
            ...
            <div className="flex flex-wrap gap-4 items-center mt-6 sm:mt-8 px-4 sm:px-0">
              <Link to='/about' className="px-4 sm:px-6 py-2 sm:py-3 bg-linear-to-r from-amber-500 to-amber-600 
              ...
              >
                <span className="absolute inset-0 bg-linear-to-r from-amber-600/30 to-transparent opacity-0 
          ...
          <div className="w-full order-2 lg:order-1 md:max-w-md lg:max-w-none lg:w-7/12 mt-12 mb-10 lg:mb-0
            relative group transform hover:scale-[1.01] transition-all duration-500"
          >
            <div className="relative rounded-[4rem] overflow-hidden border-4 border-amber-900/30 
            ...
            >
              ...
              <div className="absolute -bottom-12 left-1/2 -translate-x-1/2 w-4/5 h-16 bg-amber-600/30 
                blur-3xl z-0" />
            </div>
